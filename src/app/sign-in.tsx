...
import { Image, SafeAreaView, Button, View, TextInput, Text, KeyboardAvoidingView, Platform, Touchable, ActivityIndicator, TouchableWithoutFeedback, Keyboard } from 'react-native';
